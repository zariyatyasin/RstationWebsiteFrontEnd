...
import { fetchUserUpdate } from "../../../Redux/UserReducer/UserSlice";
...
const ProfileUpdate = () => {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    dispatch(fetchUserUpdate({ email, fullname, id, username }));
  };
  return (
    <div className="w-full rounded-md shadow-md  lg:ml-4 border">
